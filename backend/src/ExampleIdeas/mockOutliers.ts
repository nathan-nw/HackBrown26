...
export const mockOutliers: OutlierCompany[] = [
  ...
  },
  {
    id: 'airbnb',
    name: 'Airbnb',
    iconSvg: '<svg viewBox="0 0 24 24"><path fill="currentColor" d="M22.018 19.897c-3.259-2.03-5.229-5.111-5.719-5.918-.244-.403-.666-.632-1.139-.632h-.008c-.477 0-.895.234-1.137.643-.465.789-2.385 3.843-5.632 5.918-3.388 2.164-5.068 3.518-4.104 5.249.957 1.716 4.301 1.744 5.604 1.744 2.871 0 5.274-2.813 5.274-2.813s2.403 2.813 5.274 2.813c1.304 0 4.647-.027 5.604-1.744.965-1.733-.715-3.086-4.017-5.26zm-10.015-3.96c.162-.266 1.637-2.614 3.414-5.388 1.719-2.684 2.508-5.719 1.154-8.062C15.223.593 12.924.086 11.002.348 8.8.647 7.078 2.27 6.376 4.51c-1.127 3.596 1.144 8.016 5.627 11.427z"/></svg>',
    items: [
      {
        id: 'airbnb-1',
        title: 'Trust',
